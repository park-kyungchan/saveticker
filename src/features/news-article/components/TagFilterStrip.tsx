...
const tagColors: Record<string, { bg: string; text: string; activeBg: string }> = {
  "에너지":     { bg: "bg-accent-4/12", text: "text-accent-4/70",  activeBg: "bg-accent-4/20 text-accent-4 border-accent-4/30" },
  "지정학":     { bg: "bg-danger/12",    text: "text-danger/70",     activeBg: "bg-danger/20 text-danger border-danger/30" },
  "사모신용":   { bg: "bg-accent-5/12", text: "text-accent-5/70",   activeBg: "bg-accent-5/20 text-accent-5 border-accent-5/30" },
  "기업분석":   { bg: "bg-info/12",      text: "text-info/70",       activeBg: "bg-info/20 text-info border-info/30" },
  "경제지표":   { bg: "bg-accent-3/12", text: "text-accent-3/70",   activeBg: "bg-accent-3/20 text-accent-3 border-accent-3/30" },
  "헤드라인":   { bg: "bg-accent-2/12", text: "text-accent-2/70",   activeBg: "bg-accent-2/20 text-accent-2 border-accent-2/30" },
  "암호화폐":   { bg: "bg-warning/12",   text: "text-warning/70",    activeBg: "bg-warning/20 text-warning border-warning/30" },
  "정보":       { bg: "bg-white/8",      text: "text-ink-muted/70",  activeBg: "bg-white/15 text-ink border-white/20" },
};
